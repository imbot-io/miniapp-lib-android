...
class MyApplication : Application(), IAppDelegate {
    ...
    override fun onCreate() {
        ...
        val appConfig = AppConfig.Builder(
            ...
            .privacyUrl("https://docs.imbot.io/docs/standard-miniapp-privacy-policy")
            .termsOfServiceUrl("https://docs.imbot.io/docs/terms-of-service-for-mini-apps")
            .build()
    ...
    private fun sigIn() {
        ...
        openPlatformPlugin.signIn(
            context = this,
            isDev = false,
            verifier = "3611ba4b-3a2a-4ac0-97eb-9a5fa5b60ec5",
            apiHost = "https://api.m.imbot.io",
